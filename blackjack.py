    ...
    def __load_deck(self):
        ...
        for SUIT in SUITS:
            ...
            for FACE in FACE_CARDS:
                FACE_Card = FaceCard(FACE,SUIT)
                deck.append(FACE_Card)
            for NUM in num_cards:
                num_cards = Card(RANK,SUIT)
                deck.append(num_cards)
...
class Game(object):
    ...
    if get_hard_score == 21:
        print("you win")
    elif dealer.get_hard_score == 21:
        print("You Lose")
    elif get_hard_score > 21:
        print ("You Lose")
