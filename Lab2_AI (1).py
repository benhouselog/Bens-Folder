...
def winning(current_player, board):
    ...
    if (board[0][0] == current_player and board[0][1] == current_player and board[0][2] == current_player) or \
       ...
       (board[2][0] == current_player and board[2][1] == current_player and board[2][2] == current_player):
        return True
    
    # Vertical Wins
    elif (board[0][0] == current_player and board[1][0] == current_player and board[2][0] == current_player) or \
    ...
    # Diagonal Wins
    elif (board[0][0] == current_player and board[1][1] == current_player and board[2][2] == current_player) or \
